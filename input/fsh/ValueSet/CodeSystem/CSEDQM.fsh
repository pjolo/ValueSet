CodeSystem: AdministrationMethodEDQM
Id: cs-edqm-administrationmethod
Title: "Code System EDQM - Administration Method"
Description: "CodeSystem Administration method from EDQM, AME, see https://standardterms.edqm.eu/#"
* ^experimental = false
